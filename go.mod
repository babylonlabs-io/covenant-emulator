module github.com/babylonlabs-io/covenant-emulator
...
replace (
	...
	// use babylon fork of dcrec with crypto fix
	github.com/decred/dcrd/dcrec/secp256k1/v4 => github.com/babylonlabs-io/dcrd/dcrec/secp256k1/v4 v4.3.0-babylon.rc.0
