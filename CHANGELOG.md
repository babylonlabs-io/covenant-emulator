...
* [#201](https://github.com/babylonlabs-io/covenant-emulator/pull/201) chore(deps): bump msgpack to v2.4.1 and aws-sdk-go-v2 s3/eventstream to clear security advisories
