...
* [#194](https://github.com/babylonlabs-io/covenant-emulator/pull/194) chore(deps): bump docker/cli to v29.2.0,
  go-jose/v4 to v4.1.4 (security fix), and otel/sdk to v1.40.0
